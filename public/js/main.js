        ...
        var randomOpenSpot = function (newValue) {
            ...
            for (var col = 0; col < stateWidth; col++) {
                for (var row = 0; row < stateHeight; row++) {
                    if (array[row][col] === 1) openSpots.push([row, col]);
                }
            }
			...
			render: function () {
						...
						return React.createElement(
									...
									healthDisplay.map(function (item) {
												switch (item) {
															case 0:
																		return React.createElement('img', { src: 'images/heart_empty.png' });
																		break;

															case 1:
																		return React.createElement('img', { src: 'images/heart_half.png' });
																		break;

															case 2:
																		return React.createElement('img', { src: 'images/heart_full.png' });
												}
									})
						);
			}
...
var Main = React.createClass({
	...
	render: function () {
		return React.createElement(Grid, { level: this.state.level });
	}
});
